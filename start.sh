...
# Restore flows and credentials if newer
cp -u /data/node-red/flows.json /usr/src/app/app/node-red/flows.json
cp -u /data/node-red/flows_cred.json /usr/src/app/app/node-red/flows_cred.json
